...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll('.navbar .nav-link').forEach(function (link) {
    link.addEventListener('click', function () {
      document.querySelectorAll('.navbar .nav-link.is-current').forEach(function (el) {
        return el.classList.remove('is-current');
      });
  ...
  mm.add("(min-width: 992px)", function () {
    ...
    document.querySelectorAll('[data-scroll]').forEach(function (link) {
      link.addEventListener('click', function (e) {
        ...
        e.preventDefault();
        var target = document.querySelector(link.dataset.scroll);
        if (!target) return;
        var navHeight = ((_document$querySelect = document.querySelector('.navbar')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.offsetHeight) || 0;
        smoother.scrollTo(target, true, "top+=".concat(navHeight, " top"));
      });
    });
    ...
    function hero3() {
      ...
      for (var _i0 = 0; _i0 < hero3Description.length; _i0++) {
        _loop2();
      }
      for (var _i1 = 0; _i1 < hero3Btns.length; _i1++) {
        tl.from(hero3Btns[_i1], {
          opacity: 0,
          yPercent: 25,
          stagger: 0.05
        }, "-=0.25");
    ...
    function pathAnimationOn() {
      ...
      for (var _i10 = 0; _i10 < paths.length; _i10++) {
        var path = paths[_i10];
        var tl = gsap.timeline({
          scrollTrigger: {
            trigger: path,
    ...
    function pathAnimationTwo() {
      ...
      if (!paths.length) return;
      for (var _i11 = 0; _i11 < paths.length; _i11++) {
        var path = paths[_i11];
        var tl = gsap.timeline({
          scrollTrigger: {
            trigger: path,
    ...
    function textAnimation() {
      ...
      var _loop3 = function _loop3() {
        ...
        _ret;
      for (var _i12 = 0; _i12 < items.length; _i12++) {
        _ret = _loop3();
        if (_ret === 0) continue;
      }
    }
    function imageRevealAnimation() {
      ...
      for (var _i13 = 0; _i13 < imageContainers.length; _i13++) {
        var image = imageContainers[_i13];
    ...
    function fadeInAnimation() {
      ...
      for (var _i14 = 0; _i14 < fadeIn.length; _i14++) {
        var item = fadeIn[_i14];
        var scrollTriggerSupport = item.dataset.scrollTrigger;
        var animationStart = item.dataset.start || "90%";
        var animationEnd = item.dataset.end || "25%";
    ...
    function zoomAnimation() {
      ...
      for (var _i15 = 0; _i15 < zoomAnimation.length; _i15++) {
        var item = zoomAnimation[_i15];
        var scrollTriggerSupport = item.dataset.scrollTrigger;
        var animationStart = item.dataset.start || "90%";
        var animationEnd = item.dataset.end || "25%";
    ...
    function imgFlip() {
      ...
      for (var _i16 = 0; _i16 < imgFlip.length; _i16++) {
        var item = imgFlip[_i16];
